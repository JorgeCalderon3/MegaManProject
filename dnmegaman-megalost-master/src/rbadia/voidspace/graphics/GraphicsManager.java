...
public class GraphicsManager {
	...
	private BufferedImage powerUp_LifeImg;
	...
	public GraphicsManager(){
		...
		try {
			...
			this.powerUp_LifeImg = ImageIO.read(getClass().getResource("/rbadia/voidspace/graphics/PowerUp_Life.png"));
	...
	public void drawMegaManLeft (MegaMan megaMan, Graphics2D g2d, ImageObserver observer){
		g2d.drawImage(megaManImg,  megaMan.x + megaMan.width, megaMan.y, -megaMan.width, 45, observer);
	}
	...
	public void drawMegaFallL(MegaMan megaMan, Graphics2D g2d, ImageObserver observer){
		g2d.drawImage(megaFallRImg,  megaMan.x + megaMan.width, megaMan.y, -megaMan.width, 45, observer);
	}
	...
	public void drawMegaFireL (MegaMan megaMan, Graphics2D g2d, ImageObserver observer){
		g2d.drawImage(megaFireRImg,  megaMan.x + megaMan.width, megaMan.y, -megaMan.width, megaMan.height, observer);
	}
	...
	public void drawB_bullets(Bullet Bbullet, Graphics2D g2d, ImageObserver observer) {
		g2d.drawImage(bulletImg, Bbullet.x, Bbullet.y, observer);
	}
	...
	//Draws power up to specified coordinates
	public void drawPowerUp_Life(PowerUp_Life powerUp_Life, Graphics2D g2d, ImageObserver observer) {
		g2d.drawImage(powerUp_LifeImg, powerUp_Life.x, powerUp_Life.y, observer);
		
	}
	//Draws boss to specified coordinates
